...
module.exports = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper(FrameworkError);
  ...
  function FrameworkError(message) {
    ...
    _this = _super.call(this, message); // For compatibility with older node versions, set a type variable we can check

    _this.type = "FrameworkError";
    return _this;
  }

  return _createClass(FrameworkError);
