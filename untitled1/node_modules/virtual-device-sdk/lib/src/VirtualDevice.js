...
var VirtualDevice = (function () {
    function VirtualDevice(arg0, locale, voiceID, skipSTT, asyncMode, stt, locationLat, locationLong, conversationId, screenMode, client, projectId) {
        ...
        this.homophones = {};
        this.filters = [];
        this.TIMEOUTMS = process.env.VDSDK_TIMEOUT ? Number.parseInt(process.env.VDSDK_TIMEOUT) : 2000;
        this.MIN_RETRY_TIMEOUTMS = process.env.VDSDK_MIN_RETRY_TIMEOUT ?
            Number.parseInt(process.env.VDSDK_MIN_RETRY_TIMEOUT) : 2000;
        this.MAX_RETRY_TIMEOUTMS = process.env.VDSDK_MAX_RETRY_TIMEOUT ?
    ...
    VirtualDevice.prototype.addFilter = function (filter) {
        this.filters.push(filter);
    };
    VirtualDevice.prototype.clearFilters = function () {
        this.filters = [];
    };
    VirtualDevice.prototype.message = function (message, debug, phrases, newConversation) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this.agent) {
                requestOptions.agent = _this.agent || false;
            }
            var request = _this.httpInterface(urlParsed).get(requestOptions, callback);
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [2, new Promise(function (resolve, reject) {
                                ...
                                var filteredInput = _this.filters.reduce(function (accInput, filter) {
                                    try {
                                        filter(accInput);
                                    }
                                    catch (error) {
                                ...
                                var inputString = JSON.stringify(filteredInput);
                                var requestOptions = {
                                    headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        responsePromise = function () {
                            return new Promise(function (resolve, reject) {
                                ...
                                request.on("socket", function (socket) {
                                    socket.setTimeout(_this.TIMEOUTMS);
                        ...
                        return [4, util_1.retry(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4, responsePromise()];
